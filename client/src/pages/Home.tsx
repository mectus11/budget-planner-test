...
import { History, ChevronRight, Languages } from "lucide-react";
       ...
       <header className="bg-background border-b border-border/50 sticky top-0 z-10 backdrop-blur-md bg-background/80">
         <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
            <div className="flex items-center gap-2">
                 <div className="h-8 w-8 bg-primary rounded flex items-center justify-center text-lg">
                    🇹🇳
                </div>
                ...
                <SheetContent>
                    ...
                    <div className="mt-8 space-y-2">
                        ...
                        {Object.keys(savedBudgets).sort().reverse().map((key) => (
                            <div key={key} className="flex items-center justify-between p-3 rounded-lg border border-border bg-card hover:bg-accent cursor-pointer transition-colors" onClick={() => loadBudget(key)}>
            ...
            <Button variant="outline" size="sm" onClick={toggleLanguage} className="w-10 px-0">
                {language === "en" ? "FR" : "EN"}
            </Button>
            </div>
         </div>
                  ...
                  <section>
                      ...
                      <div className="space-y-6">
                          <div className="h-[400px]" ref={chartRef}>
                            <BudgetChart data={budgetData} t={t} />
                          </div>
                          <ResultsSummary data={budgetData} chartRef={chartRef} t={t} />
                      </div>
                  </section>
              </div>
          </div>
