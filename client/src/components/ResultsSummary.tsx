...
export function ResultsSummary({ data, chartRef, t }: ResultsSummaryProps) {
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="border-border/50 shadow-sm">
          ...
          <CardContent>
            <div className="text-2xl font-bold font-display">{totalExpenses.toFixed(3)} TND</div>
          </CardContent>
        </Card>
        
        <Card className={cn("border-border/50 shadow-sm", remainingBudget < 0 && "border-destructive/50 bg-destructive/5")}>
          <CardHeader className="pb-2">
