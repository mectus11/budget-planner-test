export const translations = {
  ...
  fr: {
    ...
    income: "Revenus",
    incomeDesc: "Salaire de base et revenus supplémentaires (TND).",
    ...
    expenses: "Dépenses",
    expensesDesc: "Dépenses mensuelles récurrentes (TND).",
